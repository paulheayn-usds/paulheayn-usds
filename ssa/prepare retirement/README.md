...
| [Government Pension Offset Calculator](#gpoCalc) | [Survey Image](images/gpoCalc.png) | Seems like it could be useful as an ad hoc calculator if a user is trying to understand implications of their government pension|
| [Late or Early Retirement](#lateOrEarlyCalc) | [Survey Image](images/earlyOrLateRetirement.png) | Possibly consider combining this with a benefits calculator or bridging from this calculator to a benefits calculator ("Want to estimate what 90% of your primary insurance amount? Continue to the next step and find out")|
| [Life Expectancy Calculator](#expectancyCalc) | [Survey Image](images/lifeExpectancyGenderAndAge.png), [Result Image](images/lifeExpectancyResult.png) | This functionality could be cut from scope|
| [Online Benefits Calculator](#beneCalc) | [Date of Birth Image](images/beneCalcdob.png), [Retirement Age Image](images/beneCalcRetirementAge.png), [Today or Future Dollars Image](images/beneCalctodayOrFuture.png), [Annual Earnings Image](images/beneCalcAnnualEarnings.png), [2021 Earnings Image](images/beneCalc2021Earnings.png), [2022 Earnings Image](images/beneCalc2022Earnings.png), [Survey Results Image](images/beneCalcCalculate.png), [Benefits Eligibility Image](images/beneCalcBenefitEligibilityResults.png), [Benefits Estimate Image](images/beneCalcBenefitestimatesResults.png)| OMG, 70 text fields - Why. Could we give users an estimate without asking them for every year of earnings?|
| [Quick Calculator](#quickCalc) | [Survey Image](images/quickCalc.png), [Quick Calculator Results Image](images/quickCalcResults.png) | **We might be able to update the UI on the survey page and the results page and build off of this logic** |
| [Retirement Age Calculator](#ageCalc) | [Survey Image](images/retirementAgeCalc.png), [Result Image](images/retirementAgeResult.png) | Seems like we could give the user this information as they are filling out a larger estimate |
| [Retirement Earnings Test Calculator](#earningsTestCalc) | [Survey Image](images/earningsTestCalc.png), [Result Image 1](images/estimateBenefitReductionResult.png), [Result Image 2](images/estimateBenefitsReductionResult-NoBene.png) |  This is for users working this year and eligible for retirement or survivors benefits this year. It seems like an important use case but maybe not for a separate calculator |
| [SSA Benefit Eligibility Screening Tool](#bestCalc) | [Survey Image](images/BEST.png), [Results Image](images/BESTResults.png) | _Use only as inspiration, this isn't an SSA calculator_ |
| [Windfall Elimination Provision](#pensionsAndWindfalls) | [Date of Birth Image](images/WEPdob.png), [Age At Retirement Image](images/WEPageAtRetirement.png), [Today or Future Dollars Image](images/WEPtodayOrFutureDollars.png), [Non-covered Pension Amount Image](images/WEPNon-Covered.png), [Annual Earnings Image](images/WEPAnnualEarnings.png), [2021 Earnings Image](images/WEP2021Earnings.png), [2022 Earnings Image](images/WEP2022Earnings.png), [Calculate Button Image](images/WEPCalculate.png), [Benefit Eligibility Result Image](images/WEPBenefitEligibilityResult.png), [Benefit Estimator Result Image](images/WEPBenefitEstimatorResult.png) | This is the same format as the 'Benefits Estimator'. We really need to figure out how we could avoid asking the user to enter in all years of earning and still give them an estimate. Something like tying income and asking user for their professions and using DoL data to make an estimate.|
